...
function modifier_sled_penguin_movement_self:OnCreated( kv )
	if IsServer() then
		...
		self.pinata_burst_radius = self:GetAbility():GetSpecialValueFor( "pinata_burst_radius" )
			print(self.max_sled_speed )
			print(self.speed_step )
			print(self.crash_impaired_duration )
			print(self.tree_destroy_radius )
			print(self.speed_turn )
			print(self.pinata_burst_radius )
